...
define("_LAN_01","Programa de Instalação do Nuke Lite");
...
define("_LAN_14","Servidor MySQL no qual, o Nuke Lite irá conectar-se... Verifique no seu provedor de hospedagem, qual o nome do Servidor MySQL. <br />Padrão: <b>localhost</b>");
...
define("_LAN_17","Nome do banco de dados, no qual as tabelas do Nuke Lite serão criadas. Dependendo do seu provedor, poderá ser necessário a criação do mesmo via Painel de Controle. <br />Não é permitido o uso de espaço ou caracteres especiais. Ex.: <b>voce_nuke</b>");
define("_LAN_18","Nome do arquivo que contém a estrutura e os dados das tabelas usadas pelo Nuke Lite. O arquivo deverá estar na raiz do diretorio 'instalar' <br /> Ex.: <b>nuke.sql</b>");
define("_LAN_19","Página gerada em:");
define("_LAN_20","segundos");
define("_LAN_21","Por:");
define("_LAN_22","e");
define("_LAN_23","Este Instalador do Nuke Lite é software livre lançado sob");
define("_LAN_24","licença GNU/GPL");
define("_LAN_25","é");
define("_LAN_26","de");
define("_LAN_27","Introdução");
define("_LAN_28","Bem-vindo ao programa de instalação do Nuke Lite.<br /><br />
Seguindo todos os passos corretamente, dentro de poucos minutos, seu Nuke Lite estará pronto para uso.<br />
Antes de prosseguir:<br /><br />
<li>Dê permissão <b><font color=\"#FF0033\">777</font></b> para o arquivo config.php na raíz do seu Nuke Lite ( Somente servidores Linux );</li>
...
<li>Para atualizações do seu Nuke Lite, utilize o arquivo upgrade correspondente a sua versão atual e que acompanha o pacote
de instalação.</li>");
...
define("_LAN_44","Preencha corretamente os seguintes dados: <br /><br /><b>Obs.: </b>O arquivo config.php deverá estar com permissão <b>777</b> e estar na raíz do seu Nuke Lite.");
...
Possíveis causas:
<li>O arquivo config.php não está com permissão <b>777</b>;</li>
<li>O arquivo config.php não está na raíz do seu Nuke Lite;</li><br /><br />
Possíveis soluções:
<li>Através de um cliente FTP ( consulte o manual dele para saber como fazer ), dê permissão <b>777</b> para o arquivo config.php na raíz do seu Nuke Lite;</li>
...
define("_LAN_66","O seu Nuke Lite está instalado e pronto para ser utilizado.<br /><br />
...
<center><b>Obrigado por utilizar o Nuke Lite.</b><br /><br />Não Esqueça de Apagar a pasta pasta INSTALL e todo o seu conteudo.");
...
define("_LAN_73","Informe o prefixo a ser utilizado pelas tabelas do Nuke Lite. ( <b>Não use o padrão \"nuke\"</b> )");
define("_LAN_74","Instalação do Nuke Lite v1.1");
define("_LAN_75","ERRO");
