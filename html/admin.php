...
function adminMain() {
    ...
    echo "<br>";
    OpenTable();
    $putaquipariu = "visitante(s)";
    $guest_online_num = $db->sql_numrows($db->sql_query("SELECT uname FROM ".$prefix."_session WHERE guest='1'"));
    #$member_online_num = $db->sql_numrows($db->sql_query("SELECT uname FROM ".$prefix."_session WHERE guest='0'"));
    $who_online_num = $guest_online_num;
    $who_online = "<center><font class=\"option\">"._WHOSONLINE."</font><br><br><font class=\"content\">"._CURRENTLY." $guest_online_num $putaquipariu<br>";
...
# $Log: admin.php,v $
# Revision 1.4  2004/12/21 19:54:35  chatserv
