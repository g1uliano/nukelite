...
if ($forum_admin != 1) {
	...
	if (file_exists("language/lang-brazilian.php")) {
	    setcookie("lang",$newlang,time()+31536000);
	    include("language/lang-brazilian.php");
	    $currentlang = $newlang;
	} else {
...
function get_lang($module) {
    ...
    if (file_exists("modules/$module/language/lang-brazilian.php")) {
	if ($module == admin) {
	    include_once("admin/language/lang-brazilian.php");
	} else {
	    include_once("modules/$module/language/lang-brazilian.php");
	}
    } else {
	if ($module == admin) {
	    include_once("admin/language/lang-brazilian.php");
